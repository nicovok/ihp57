                ...
                <div className="absolute inset-0 w-full h-full backdrop-blur-sm flex flex-col text-center justify-center items-center">
                    <div className="max-w-sm">
                        <p className="font-bold uppercase text-xl">
                            Köszönjük, hogy kitöltötted az
                            űrlapot!
                        </p>
                        <p>
                            Néhány napon belül felvesszük
                            veled a kapcsolatot az általad
            ...
            {status > 200 && (
                <div className="absolute inset-0 w-full h-full backdrop-blur-sm flex flex-col text-center justify-center items-center">
                    <div className="max-w-sm">
                        ...
                        <p>
                            Valamilyen hiba történt az űrlap
                            beküldése közben. Kérlek próbáld
                            újra később, vagy keress fel
                            minket telefonon, vagy e-mailen.
                        </p>
                        <button
                            className="px-3 py-2 border border-black mt-5"
                            onClick={() => setStatus(0)}
